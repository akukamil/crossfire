...
var my_data = {};
var load_list=[["sprite","bcg5","objects[obj_name].interactive=true;objects[obj_name].sx=objects[obj_name].x=-20;objects[obj_name].sy=objects[obj_name].y=-10;","app.stage.addChild(objects[obj_name]);"],["sprite","game_name","objects[obj_name].visible=false;objects[obj_name].sx=objects[obj_name].x=225;objects[obj_name].sy=objects[obj_name].y=193;objects[obj_name].anchor.set(0.5,0.5);","app.stage.addChild(objects[obj_name]);"],["sprite","button_1","objects[obj_name].visible=false;objects[obj_name].sx=objects[obj_name].x=220;objects[obj_name].sy=objects[obj_name].y=620;objects[obj_name].anchor.set(0.5,0.5);objects[obj_name].ready=true;objects[obj_name].buttonMode=true;objects[obj_name].pointerdown=()=>process_1.button_down();","app.stage.addChild(objects[obj_name]);"],["sprite","baloon5","objects[obj_name].visible=false;objects[obj_name].sx=objects[obj_name].x=166;objects[obj_name].sy=objects[obj_name].y=408;objects[obj_name].anchor.set(0.5,0.5);","app.stage.addChild(objects[obj_name]);"],["sprite","bow5","objects[obj_name].visible=false;objects[obj_name].sx=objects[obj_name].x=294;objects[obj_name].sy=objects[obj_name].y=500;objects[obj_name].anchor.set(0.5,0.5);","app.stage.addChild(objects[obj_name]);"],["image","baloon",""],["image","arrow",""],["image","bow",""],["image","bow2",""],["image","baloon_bonus_arrows",""],["image","baloon_bonus_slow",""],["image","brick_baloon",""],["image","bonus_5",""],["image","bonus_1",""],["image","bonus_10",""],["image","baloon_bonus_hand",""],["image","baloon_bonus_hand2",""],["sprite","pause_button","objects[obj_name].visible=false;objects[obj_name].sx=objects[obj_name].x=360;objects[obj_name].sy=objects[obj_name].y=720;objects[obj_name].ready=true;objects[obj_name].interactive=true;objects[obj_name].buttonMode=true;objects[obj_name].pointerdown=function(){process_3.button_down()};","app.stage.addChild(objects[obj_name]);"],["block","hand_click","objects[obj_name]=new PIXI.AnimatedSprite([game_res.resources['hand_click_0'].texture,game_res.resources['hand_click_1'].texture]);objects[obj_name].visible=false;objects[obj_name].sx=objects[obj_name].x=330;objects[obj_name].sy=objects[obj_name].y=500;objects[obj_name].width=200;objects[obj_name].height=229.99990234375;objects[obj_name].anchor.set(0.5,0.5);objects[obj_name].animationSpeed=0.1;","app.stage.addChild(objects[obj_name]);"],["image","hand_click_0",""],["image","hand_click_1",""],["block","bow","objects[obj_name]=new PIXI.Sprite();objects[obj_name].visible=false;objects[obj_name].sx=objects[obj_name].x=225;objects[obj_name].sy=objects[obj_name].y=470;objects[obj_name].anchor.set(0.5,0.5);objects[obj_name].texture=game_res.resources['bow'].texture;","app.stage.addChild(objects[obj_name]);"],["block","arrow","objects[obj_name]=new arrow_class();objects[obj_name].visible=false;objects[obj_name].sx=objects[obj_name].x=225;objects[obj_name].sy=objects[obj_name].y=470;objects[obj_name].anchor.set(0.5,0.5);objects[obj_name].texture=game_res.resources['arrow'].texture;","app.stage.addChild(objects[obj_name]);"],["array","baloons",50,"var o = obj_name;var num=n;objects[o][num]=new baloon_class();objects[o][num].visible=false;objects[o][num].x=-30;objects[o][num].y=400;objects[o][num].sx=-30;objects[o][num].sy=400;objects[o][num].anchor.set(0.5,0.5);objects[o][num].alpha=0.8;objects[o][num].texture=game_res.resources['baloon'].texture;","var o = obj_name;var num=n;app.stage.addChild(objects[o][num]);"],["array","arrows",40,"var o = obj_name;var num=n;objects[o][num]=new arrow_class();objects[o][num].anchor.set(0.5,0.5);objects[o][num].texture=game_res.resources['arrow'].texture;objects[o][num].visible=false;","var o = obj_name;var num=n;app.stage.addChild(objects[o][num]);"],["block","level_note","objects[obj_name]=new PIXI.BitmapText('', {font: '32px Century Gothic'});objects[obj_name].sx=objects[obj_name].x=167;objects[obj_name].sy=objects[obj_name].y=83;objects[obj_name].anchor.set(0.5,0.5);",""],["block","arrows_info_text","objects[obj_name]=new PIXI.BitmapText('', {font: '30px Century Gothic'});objects[obj_name].sx=objects[obj_name].x=80;objects[obj_name].sy=objects[obj_name].y=13;",""],["sprite","arrows_info_3","objects[obj_name].sx=objects[obj_name].x=10;objects[obj_name].sy=objects[obj_name].y=-7;",""],["sprite","heart_icon","objects[obj_name].sx=objects[obj_name].x=170;objects[obj_name].sy=objects[obj_name].y=-7;",""],["block","life_info","objects[obj_name]=new PIXI.BitmapText('', {font: '30px Century Gothic'});objects[obj_name].sx=objects[obj_name].x=240;objects[obj_name].sy=objects[obj_name].y=13;",""],["cont","game_ui_cont","objects[obj_name]=new PIXI.Container();objects[obj_name].ready=true;objects[obj_name].visible=false;objects[obj_name].sx=objects[obj_name].x=60;objects[obj_name].sy=objects[obj_name].y=0;","objects[obj_name].addChild(objects.arrows_info_3);objects[obj_name].addChild(objects.arrows_info_text);objects[obj_name].addChild(objects.heart_icon);objects[obj_name].addChild(objects.life_info);objects[obj_name].addChild(objects.level_note);app.stage.addChild(objects[obj_name]);"],["sprite","game_end","objects[obj_name].visible=false;objects[obj_name].sx=objects[obj_name].x=-10;objects[obj_name].sy=objects[obj_name].y=190;objects[obj_name].interactive=true;","app.stage.addChild(objects[obj_name]);"],["sprite","win","objects[obj_name].visible=false;objects[obj_name].sx=objects[obj_name].x=-10;objects[obj_name].sy=objects[obj_name].y=190;objects[obj_name].interactive=true;","app.stage.addChild(objects[obj_name]);"],["sprite","star1","objects[obj_name].visible=false;objects[obj_name].sx=objects[obj_name].x=50;objects[obj_name].sy=objects[obj_name].y=280;","app.stage.addChild(objects[obj_name]);"],["sprite","star2","objects[obj_name].visible=false;objects[obj_name].sx=objects[obj_name].x=170;objects[obj_name].sy=objects[obj_name].y=280;","app.stage.addChild(objects[obj_name]);"],["sprite","star3","objects[obj_name].visible=false;objects[obj_name].sx=objects[obj_name].x=290;objects[obj_name].sy=objects[obj_name].y=280;","app.stage.addChild(objects[obj_name]);"],["sprite","game_over","objects[obj_name].visible=false;objects[obj_name].sx=objects[obj_name].x=-10;objects[obj_name].sy=objects[obj_name].y=190;objects[obj_name].interactive=true;","app.stage.addChild(objects[obj_name]);"],["sprite","pause_block","objects[obj_name].visible=false;objects[obj_name].sx=objects[obj_name].x=-10;objects[obj_name].sy=objects[obj_name].y=190;objects[obj_name].interactive=true;","app.stage.addChild(objects[obj_name]);"],["sprite","retry_button","objects[obj_name].visible=false;objects[obj_name].sx=objects[obj_name].x=125;objects[obj_name].sy=objects[obj_name].y=590;objects[obj_name].anchor.set(0.5,0.5);objects[obj_name].ready=true;objects[obj_name].interactive=true;objects[obj_name].buttonMode=true;objects[obj_name].pointerdown=function(){lose.button_down()};","app.stage.addChild(objects[obj_name]);"],["sprite","next_level_button","objects[obj_name].visible=false;objects[obj_name].sx=objects[obj_name].x=330;objects[obj_name].sy=objects[obj_name].y=590;objects[obj_name].anchor.set(0.5,0.5);objects[obj_name].ready=true;objects[obj_name].interactive=true;objects[obj_name].buttonMode=true;objects[obj_name].pointerdown=function(){win.next_button_down(1)};","app.stage.addChild(objects[obj_name]);"],["sprite","resume_button","objects[obj_name].visible=false;objects[obj_name].sx=objects[obj_name].x=225;objects[obj_name].sy=objects[obj_name].y=590;objects[obj_name].anchor.set(0.5,0.5);objects[obj_name].ready=true;objects[obj_name].interactive=true;objects[obj_name].buttonMode=true;objects[obj_name].pointerdown=()=>process_7.button_down();","app.stage.addChild(objects[obj_name]);"],["sprite","replay_level_button","objects[obj_name].visible=false;objects[obj_name].sx=objects[obj_name].x=130;objects[obj_name].sy=objects[obj_name].y=590;objects[obj_name].anchor.set(0.5,0.5);objects[obj_name].ready=true;objects[obj_name].interactive=true;objects[obj_name].buttonMode=true;objects[obj_name].pointerdown=function(){win.next_button_down(0)};","app.stage.addChild(objects[obj_name]);"],["sprite","bonus","objects[obj_name]=new PIXI.Sprite();objects[obj_name].visible=false;objects[obj_name].sx=objects[obj_name].x=225;objects[obj_name].sy=objects[obj_name].y=450;objects[obj_name].anchor.set(0.5,0.5);","app.stage.addChild(objects[obj_name]);"],["sprite","ad_for_arrows_button","objects[obj_name].visible=false;objects[obj_name].sx=objects[obj_name].x=325;objects[obj_name].sy=objects[obj_name].y=590;objects[obj_name].anchor.set(0.5,0.5);objects[obj_name].ready=true;objects[obj_name].interactive=true;objects[obj_name].buttonMode=true;objects[obj_name].pointerdown=function(){lose.ad_for_arrows()};","app.stage.addChild(objects[obj_name]);"],["cont","message_box_cont","objects[obj_name]=new PIXI.Container();objects[obj_name].ready=true;objects[obj_name].visible=false;objects[obj_name].sx=objects[obj_name].x=-10;objects[obj_name].sy=objects[obj_name].y=-10;","objects[obj_name].addChild(objects.message_box);objects[obj_name].addChild(objects.message_text);app.stage.addChild(objects[obj_name]);"],["sprite","message_box","objects[obj_name].sx=objects[obj_name].x=10;objects[obj_name].sy=objects[obj_name].y=10;",""],["block","message_text","objects[obj_name]=new PIXI.BitmapText('Привет', {font: '10px Century Gothic',align: 'center'});objects[obj_name].anchor.set(0.5,0.5);objects[obj_name].x=220;objects[obj_name].y=45;",""],["image","button_1_loading",""],["sprite","ups_block","objects[obj_name].visible=false;objects[obj_name].sx=objects[obj_name].x=-10;objects[obj_name].sy=objects[obj_name].y=190;objects[obj_name].interactive=true;","app.stage.addChild(objects[obj_name]);"],["sprite","ups_ok_button","objects[obj_name].visible=false;objects[obj_name].sx=objects[obj_name].x=100;objects[obj_name].sy=objects[obj_name].y=570;objects[obj_name].ready=true;objects[obj_name].interactive=true;objects[obj_name].buttonMode=true;objects[obj_name].pointerdown=function(){ups.close()};","app.stage.addChild(objects[obj_name]);"]];var baloons_sent = 0;
var baloons_cnt = 10;
var arrows_cnt = 20;
var arrows_bonus = 0;
